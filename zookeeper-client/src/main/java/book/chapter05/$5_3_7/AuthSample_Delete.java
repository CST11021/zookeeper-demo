...
public class AuthSample_Delete {
    ...
    public static void main(String[] args) throws Exception {
        ...
        ZooKeeper zookeeper1 = new ZooKeeper("192.168.85.128:2181",5000,null);
        ...
        try {
			ZooKeeper zookeeper2 = new ZooKeeper("192.168.85.128:2181",50000,null);
			zookeeper2.delete( PATH2, -1 );
		} catch ( Exception e ) {
			System.out.println( "删除节点失败: " + e.getMessage() );
		}
        
        ZooKeeper zookeeper3 = new ZooKeeper("192.168.85.128:2181",50000,null);
        zookeeper3.addAuthInfo("digest", "foo:true".getBytes());
		zookeeper3.delete( PATH2, -1 );
        System.out.println( "成功删除节点：" + PATH2 );
        
        ZooKeeper zookeeper4 = new ZooKeeper("192.168.85.128:2181",50000,null);
